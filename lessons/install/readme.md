...
I already have Python 3 installed, because the online course I took to learn it used Python 3. Also, all HackerRank Python pre-work is configured for Python 3 only.
